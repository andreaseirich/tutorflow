...
class PromptBuildingTest(TestCase):
    ...
    def setUp(self):
        ...
        self.student = Student.objects.create(
            first_name="Max", last_name="Mustermann", grade="10. Klasse", subjects="Mathe, Deutsch"
        )
    ...
    def test_extract_subject_from_student(self):
        ...
        student_no_subject = Student.objects.create(first_name="Anna", last_name="Schmidt")
...
class LessonPlanServiceTest(TestCase):
    ...
    def setUp(self):
        """Set up test data."""
        self.student = Student.objects.create(
            first_name="Max", last_name="Mustermann", grade="10. Klasse", subjects="Mathe"
        )
        self.contract = Contract.objects.create(
            student=self.student, hourly_rate=Decimal("25.00"), start_date=date.today()
        )
